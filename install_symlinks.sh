...
mkdir -p "$TARGET"
for f in generate_db_json_local.sh run_withdrawals_and_transfer_local.sh patch_db_json_live.sh refresh_db_json_baseline.sh run_db_json_epoch_watch.sh check_platform_explorer_vs_dashmate.sh monitor_new_blocks_count.sh push_generate_db_json_local.sh update_ip2location_db.sh transfer_ip2location_db.sh update_and_transfer_ip2location_db.sh; do
